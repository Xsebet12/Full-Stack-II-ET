...
public class ControladorAutenticacion {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Datos de registro", required = true,
        content = @Content(mediaType = "application/json", schema = @Schema(implementation = SolicitudRegistro.class), examples = @ExampleObject(value = "{\"nombres\":\"Juan\",\"apellidos\":\"Pérez\",\"rut\":\"12345678\",\"dv\":\"9\",\"correo\":\"juan@example.com\",\"telefono\":\"+56 9 1234 5678\",\"contrasena\":\"secret\",\"direccion\":\"Av. Siempre Viva 123\",\"comunaId\":13101}")))
    @ApiResponses({
